...
type
  ...
  private
    ...
    FMunicipalityId, FCountyId, FStateId, FCountryId: Integer;
...
procedure TedtInstitution.ControlEnter(Sender: TObject);
var
  Ctrl: TControl;
  R: TRect;
begin
...
procedure TedtInstitution.GetStateCountry(Sender: TObject);
var
