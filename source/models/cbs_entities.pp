...
const
  GoalStatusStr: array [TGoalStatus] of String = ('P', 'R', 'C');
...
const
  ActivityStatusStr: array[TActivityStatus] of String = ('T','P','F','C','D','R','B');
...
begin
  ...
  try
    ...
    JSONObject.Add('Status', GoalStatusStr[FStatus]);
...
begin
  ...
  try
    ...
    JSONObject.Add('Status', ActivityStatusStr[FStatus]);
