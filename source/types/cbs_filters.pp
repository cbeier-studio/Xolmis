    ...
    case aTable of
      tbNone:
        begin
          ...
          Add('JOIN TaxaDetails AS s ON i.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON i.family_id = f.taxon_id');
          Add('JOIN TaxaDetails AS o ON i.order_id = o.taxon_id');
          ...
          Add('JOIN TaxaDetails AS s ON c.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON c.family_id = f.taxon_id');
          ...
          Add('JOIN TaxaDetails AS s ON ac.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON ac.family_id = f.taxon_id');
          Add('JOIN TaxaDetails AS o ON ac.order_id = o.taxon_id');
          ...
          Add('  t.sort_num AS sort_num');
          Add('FROM nests AS n');
          Add('JOIN TaxaDetails AS s ON n.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON n.family_id = f.taxon_id');
          Add('JOIN TaxaDetails AS o ON n.order_id = o.taxon_id');
          ...
          Add('  t.sort_num AS sort_num');
          Add('FROM eggs AS e');
          Add('JOIN TaxaDetails AS s ON e.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON e.family_id = f.taxon_id');
          Add('JOIN TaxaDetails AS o ON e.order_id = o.taxon_id');
          ...
          Add('JOIN TaxaDetails AS s ON sp.species_id = s.taxon_id');
          Add('JOIN TaxaDetails AS f ON sp.family_id = f.taxon_id');
          Add('JOIN TaxaDetails AS o ON sp.order_id = o.taxon_id');
          Add('JOIN TaxaDetails AS t ON sp.taxon_id = t.taxon_id');
    ...
    case aTable of
      tbNone:
        begin
          ...
          Add('JOIN SiteDetails AS m ON e.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON e.state_id = s.site_id');
          ...
          Add('   p.site_name AS country_name');
          Add('FROM nests AS n');
          Add('JOIN SiteDetails AS m ON n.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON n.state_id = s.site_id');
          ...
          Add('   p.site_name AS country_name');
          Add('FROM sightings AS ac');
          Add('JOIN SiteDetails AS m ON ac.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON ac.state_id = s.site_id');
          ...
          Add('   p.site_name AS country_name');
          Add('FROM captures AS c');
          Add('JOIN SiteDetails AS m ON c.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON c.state_id = s.site_id');
          ...
          Add('JOIN SiteDetails AS m ON xp.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON xp.state_id = s.site_id');
          ...
          Add('JOIN SiteDetails AS m ON a.municipality_id = m.site_id');
          Add('JOIN SiteDetails AS s ON a.state_id = s.site_id');
