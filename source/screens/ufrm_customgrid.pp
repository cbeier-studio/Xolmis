...
begin
  ...
  pSide.Color := ActiveTheme.Background.SolidTertiary;
  scrollFilter.Color := ActiveTheme.Background.SolidTertiary;
  pQuickFiltersContent.Background.Color := ActiveTheme.Background.SolidTertiary;
  pFiltersToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  pFiltersToolbar.Border.Color := ActiveTheme.Background.CardSecondary;
  pImagesToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  pImagesToolbar.Border.Color := ActiveTheme.Background.CardSecondary;
  pAudiosToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  pAudiosToolbar.Border.Color := ActiveTheme.Background.CardSecondary;
  pVideosToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  pVideosToolbar.Border.Color := ActiveTheme.Background.CardSecondary;
  pDocsToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  ...
  pMsgSummary.Border.Color := ActiveTheme.Background.CardSecondary;
  pMsgSummary.FontEx.Color := ActiveTheme.Foreground.TextPrimary;
  pMsgSummary.Color := gridSummary.Color;

  pEmptyQuery.Background.Color := ActiveTheme.Background.CardDefault;
  pEmptyQuery.Border.Color := ActiveTheme.Background.CardSecondary;
  pEmptyQuery.Color := DBG.Color;

  pRecordToolbar.Background.Color := ActiveTheme.Background.CardDefault;
  pRecordToolbar.Border.Color := ActiveTheme.Background.CardSecondary;
  pRecordStatus.Background.Color := ActiveTheme.Background.CardDefault;
  pRecordStatus.Border.Color := ActiveTheme.Background.CardSecondary;
  ...
  pChildStatus.Background.Color := ActiveTheme.Background.CardDefault;
  pChildStatus.Border.Color := ActiveTheme.Background.CardSecondary;
  pChildsBar.Background.Color := ActiveTheme.Background.CardDefault;
  pChildsBar.Border.Color := ActiveTheme.Background.CardSecondary;
  pChildRightPanel.Background.Color := ActiveTheme.Background.SolidSecondary;
  pChildRightPanel.Border.Color := ActiveTheme.Background.CardSecondary;

  pSideToolbar.Color := ActiveTheme.Background.SolidQuaternary;

  // Set font colors
  titleViewRecord.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleQuickFilters.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleImages.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleAudios.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleVideos.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleDocs.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleMap.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleSummary.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleColumns.Font.Color := ActiveTheme.Interactive.WindowTitle;
  titleRecycle.Font.Color := ActiveTheme.Interactive.WindowTitle;
  ...
  pSiteFilters.Background.Color := ActiveTheme.Background.CardDefault;
  pSiteFilters.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTitleSiteFilter.Color := ActiveTheme.Background.CardDefault;
  pSiteRankFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pSiteRankFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTaxonRanksFilters.Background.Color := ActiveTheme.Background.CardDefault;
  pTaxonRanksFilters.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTitleTaxonRanksFilter.Color := ActiveTheme.Background.CardDefault;
  pMaterialFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pMaterialFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pMethodFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pMethodFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pCategoryFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pCategoryFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBandSizeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBandSizeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pWithRecapturesFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pWithRecapturesFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pFatFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pFatFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBandStatusFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBandStatusFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pDatesFilters.Background.Color := ActiveTheme.Background.CardDefault;
  pDatesFilters.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pDateFilter.Color := ActiveTheme.Background.CardDefault;
  pNestFateFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNestFateFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNestSupportFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNestSupportFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTaxonFilters.Background.Color := ActiveTheme.Background.CardDefault;
  pTaxonFilters.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTitleTaxonFilter.Color := ActiveTheme.Background.CardDefault;
  pExtinctFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pExtinctFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pWithColorBandsFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pWithColorBandsFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pSexFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pSexFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pCloacalProtuberanceFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pCloacalProtuberanceFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBroodPatchFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBroodPatchFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pHowSexedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pHowSexedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pReportedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pReportedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pIsSynonymFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pIsSynonymFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pHasSynonymsFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pHasSynonymsFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBodyMoltFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBodyMoltFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pFFMoltFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pFFMoltFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pFFWearFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pFFWearFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pMoltLimitsFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pMoltLimitsFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pMoltCycleFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pMoltCycleFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTaxonomyClementsFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pTaxonomyClementsFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTaxonomyIocFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pTaxonomyIocFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pTaxonomyCbroFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pTaxonomyCbroFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pStartTimeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pStartTimeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEndTimeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEndTimeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pAgeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pAgeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pSkullOssificationFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pSkullOssificationFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pHowAgedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pHowAgedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pMarkedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pMarkedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pPersonFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pPersonFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pInstitutionFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pInstitutionFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pSurveyFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pSurveyFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pProjectFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pProjectFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNestFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNestFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pIndividualFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pIndividualFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pSamplingPlotFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pSamplingPlotFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pExpeditionFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pExpeditionFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pPlantFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pPlantFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNeedsReviewFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNeedsReviewFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEscapedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEscapedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pRecordInEbirdFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pRecordInEbirdFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEggFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEggFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pOutOfSampleFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pOutOfSampleFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNidoparasiteFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNidoparasiteFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pHatchedFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pHatchedFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pPhilornisFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pPhilornisFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pCaptureTypeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pCaptureTypeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pCaptureStatusFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pCaptureStatusFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBandTypeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBandTypeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pBandSourceFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pBandSourceFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNestStatusFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNestStatusFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pNestStageFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pNestStageFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEggPatternFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEggPatternFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEggTextureFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEggTextureFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pEggShapeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pEggShapeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pPermitTypeFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pPermitTypeFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  pReplacedBandFilter.Background.Color := ActiveTheme.Background.CardDefault;
  pReplacedBandFilter.Border.Color := ActiveTheme.System.SolidNeutralFG;
  ...
  tvSiteFilter.Colors.TreeLineColor := ActiveTheme.Foreground.TextSecondary;
  tvDateFilter.Colors.TreeLineColor := ActiveTheme.Foreground.TextSecondary;
  tvTaxaFilter.Colors.TreeLineColor := ActiveTheme.Foreground.TextSecondary;
