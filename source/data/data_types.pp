...
const
  ...
  TABLE_NAMES: array [TTableType] of String = ('',
    ...
    'poi_library',
    'videos');
  PRIMARY_KEY_FIELDS: array [TTableType] of String = ('',
    'user_id',
    'event_id',
    'verification_id',
    'site_id',
...
uses utils_locale, utils_global, utils_conversions, utils_dialogs, data_search, udm_main, udlg_validate;
...
begin
  ...
  begin
    if SEARCH_DATA_TYPES[TSearchDataType(i)] = aFilterName then
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      // Direction
      aSort := aSort + ' ' + SORT_DIRECTIONS[FSortFields[i].Direction];
