...
uses
  Classes, SysUtils, StdCtrls, DB, SQLDB, data_types;
...
begin
  ...
  begin
    ...
    Add('  z.scientific_name AS taxon_name,');
...
begin
  ...
  begin
    ...
    Add('  btp.scientific_name AS parent_taxon_name,');
    Add('  btv.scientific_name AS valid_name');
...
begin
  ...
  begin
    ...
    Add('  z.scientific_name AS taxon_name,');
    Add('  z.formatted_name AS taxon_formatted_name,');
    Add('  bt1.scientific_name AS support_plant_1_name,');
    Add('  bt2.scientific_name AS support_plant_2_name');
    Add('FROM nests AS n');
...
begin
  ...
  begin
    ...
    Add('   g.site_name AS locality_name,');
    Add('   p1.abbreviation AS bander_name,');
    Add('   p2.abbreviation AS annotator_name,');
    Add('   (b1.band_size||'' ''||b1.band_number) AS band_name,');
    Add('   (b2.band_size||'' ''||b2.band_number) AS removed_band_name,');
    Add('   f1.abbreviation AS photographer_1_name,');
    Add('   f2.abbreviation AS photographer_2_name');
...
begin
  ...
  begin
    ...
    Add('    u.scientific_name AS parent_taxon_name,');
    Add('    v.scientific_name AS valid_name,');
    Add('    ui.scientific_name AS ioc_parent_name,');
    Add('    vi.scientific_name AS ioc_valid_name,');
    Add('    o.scientific_name AS order_name,');
    Add('    f.scientific_name AS family_name,');
    Add('    s.scientific_name AS subfamily_name,');
    Add('    n.scientific_name AS genero_name,');
    Add('    e.scientific_name AS species_name,');
    Add('    g.scientific_name AS subspecies_group_name');
...
begin
  ...
  begin
    ...
    Add('  it.abbreviation AS supplier_name,');
